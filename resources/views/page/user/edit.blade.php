...
@section('content')
<form method="post" action="{{ route('user.index')}}" enctype="multipart/form-data" class="card">
    {{ csrf_field() }}
    @method('GET')
      ...
      <div class="col-6">
        <div class="card-body">
          <div class="form-group mb-3">
              ...
              <div>
                  <input type="text" name="username" value="{{ $data->username }}" class="form-control" placeholder="Enter Username"/>
              </div>
      ...
      <div class="col-6">
        <div class="card-body">
          <div class="form-group mb-3">
            ...
            <div>
              <input type="tel" name="phone" value="{{ $data->phone }}" class="form-control" placeholder="Enter Phone Number">
            </div>
