...
>
  <head>
    ...
    <!-- Favicon -->
    <link rel="icon" type="image/x-icon" href="{{ asset('assets/auth/auth/images/favicon.ico') }}" />
  ...
  <body>
    ...
    <!-- Vendors JS -->
    <script src="{{ asset('assets/auth/vendor/libs/apex-charts/apexcharts.js')}}"></script>
